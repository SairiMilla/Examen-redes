...
/*writes in a file descriptor the key-values of the dictionary*/
void DictList(Dict d, int fd);

/*returns the number of keys of the dictionary*/
int DictSize(Dict d);

/*Writes a string in a file descriptor, specifically, a socket*/
void write_string(int fd, char* palabra);